...
export default function EditAccident() {
    ...
    const [state, setState] = useState({
        ...
        showPassword: false, message: '', existingData: {}
    });
    ...
    useEffect(() => {
        ...
        getRequestHandler({
            ...
            successCallback: body => {
                if (body?.result)
                    updateState({ existingData: body?.result })
            },
            errorCallback: err => {
    ...
    const formik = useFormik({
        initialValues: { date: moment().format('yyyy-MM-DD'), plateNumber: '', location: '', casualties: 0, degree: '', details: '' },
        ...
        onSubmit: async value => {
            ...
            await postRequestHandler({
                route: `/api/update-${currentPath}`, body: { ...body, id: id, type: currentPath },
                successCallback: body => {
