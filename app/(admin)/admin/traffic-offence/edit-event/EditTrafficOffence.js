...
export default function EditTrafficOffence() {
    ...
    const formik = useFormik({
        initialValues: { date: moment().format('yyyy-MM-DD'), plateNumber: '', location: '', category: '', details: '' },
        ...
        onSubmit: async value => {
            const body = {
                ...
                details: value?.details, category: value?.category
            }
    ...
    return (
        <Box sx={{ maxWidth: '60%', mx: 'auto' }}>
            ...
            {state.existingData && <form onSubmit={formik.handleSubmit}>
                ...
                <Box>
                    {label({ label: 'Category of offence' })}
                    {textField({
